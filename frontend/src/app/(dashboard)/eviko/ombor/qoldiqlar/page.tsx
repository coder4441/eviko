        ...
        const load = async () => {
            try {
                const [xomashyoRes, mahsulotRes] = await Promise.all([
                    fetch("/api/eviko/xomashyo?type=xomashyo"),
                    fetch("/api/eviko/menu"),
                ]);
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-5">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto mt-2 sm:mt-0">
                        ...
                        <Link href="/eviko/nomenklatura/xomashyo">
                                ...
                                {loading ? (
                                    ...
                                    <tr><td colSpan={7} className="py-16 text-center">
                                        <div className="flex flex-col items-center gap-3 text-slate-400">
                                            ...
                                            <Link href="/eviko/nomenklatura/xomashyo" className="text-blue-600 font-semibold hover:underline text-sm">{t('nav.nomenclature')} {t('common.add')}</Link>
                                        </div>
                                    </td></tr>
