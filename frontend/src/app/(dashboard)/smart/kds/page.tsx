...
import { CheckCircle2, Clock, Check, Utensils, AlertTriangle } from "lucide-react";
...
export default function KDSPage() {
    ...
    const fetchOrders = async () => {
        try {
            const res = await fetch("/api/smart/kds");
            if (res.ok) {
            ...
            <header className="flex justify-between items-center mb-6 shrink-0 bg-white p-4 rounded-2xl shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium">Buyurtmalarni boshqarish markazi</p>
                    </div>
                </div>
