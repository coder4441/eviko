/**
 * /api/eviko/print-kitchen — Oshxona chekini SERVER tomonda ishonchli chiqarish.
 *
...
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            ...
            const fp = printers.find(p => p.role === 'kitchen') || printers[0];
            if (fp) fallbackIp = fp.ipAddress || null;
        } catch {}
