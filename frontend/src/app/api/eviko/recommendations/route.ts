/**
 * /api/eviko/recommendations — Smart Tavsiyalar API
 *
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.error("GET /api/eviko/recommendations error:", error);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error("POST /api/eviko/recommendations error:", error);
        return NextResponse.json({ error: "Server xatoligi" }, { status: 500 });
    }
}
...
export async function PUT(request: NextRequest) {
    try {
        ...
        console.error("PUT /api/eviko/recommendations error:", error);
        return NextResponse.json({ error: "Server xatoligi" }, { status: 500 });
    }
}
...
export async function DELETE(request: NextRequest) {
    try {
        ...
        console.error("DELETE /api/eviko/recommendations error:", error);
        return NextResponse.json({ error: "Server xatoligi" }, { status: 500 });
    }
}
...
export async function PATCH(request: NextRequest) {
    try {
        ...
        console.error("PATCH /api/eviko/recommendations error:", error);
        return NextResponse.json({ error: "Server xatoligi" }, { status: 500 });
    }
}
