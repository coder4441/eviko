...
import {
    ...
    DollarSign, Clock, Headset, CreditCard, Building2, ChevronDown, MonitorPlay
} from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
    ...
    {
        href: "/smart/kds", icon: MonitorPlay, key: "Ekranlar",
        subItems: [
            { href: "/smart/kds", label: "Oshxona (KDS)", isI18n: false },
            { href: "/smart/qr-menu", label: "QR Menyu", isI18n: false },
        ]
    },
    {
