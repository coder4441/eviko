...
const translations: Record<Language, Record<string, Record<string, string>>> = {
    uz: {
        common: {
            ...
            view: "Ko'rish", units: "dona", refresh: "Yangilash", and: "va", all: "Barchasi"
        },
        nav: {
            ...
            qr_menu: "QR Menyu",
            fin_cash: "Kassa & P&L", contractors: "Kontragentlar", kont_suppliers: "Yetkazib beruvchilar", kont_clients: "Mijozlar", support: "Tex yordam", billing: "Obuna va Tariflar", printers: "Printerlar"
        },
        dashboard: {
    ...
    ru: {
        common: {
            ...
            view: "Посмотреть", units: "шт", refresh: "Обновить", and: "и", all: "Все"
        },
        nav: {
            ...
            fin_cash: "Касса и P&L", contractors: "Контрагенты", kont_suppliers: "Поставщики", kont_clients: "Клиенты", support: "Техподдержка", billing: "Подписка и Тарифы", printers: "Принтеры"
        },
        dashboard: {
    ...
    en: {
        common: {
            ...
            view: "View", units: "pcs", refresh: "Refresh", and: "and", all: "All"
        },
        nav: {
            ...
            fin_cash: "Cash & P&L", contractors: "Contractors", kont_suppliers: "Suppliers", kont_clients: "Clients", support: "Support", billing: "Subscription & Tarif", printers: "Printers"
        },
        dashboard: {
