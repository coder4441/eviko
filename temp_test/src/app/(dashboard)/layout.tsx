...
export default function DashboardLayout({
    ...
    const blockedFeatureName = (() => {
        if (pathname?.startsWith("/eviko/ombor") && !useWarehouse) return "Ombor boshqaruvi";
        if (pathname?.startsWith("/eviko/reports") && !useAnalytics) return "Analitika va Hisobotlar";
        if (pathname?.startsWith("/eviko/kontragent") && !useCRM) return "Mijozlar bilan ishlash (CRM)";
        return null;
    })();
