...
import {
    ...
    Home, PieChart, Users, ShoppingBag, QrCode
} from "lucide-react";
...
const MOBILE_BOTTOM_NAV = [
    { href: "/eviko", icon: Home, label: "Bosh sahifa" },
    { href: "/eviko/reports", icon: PieChart, label: "Hisobotlar" },
    { href: "/eviko/users", icon: Users, label: "Xodimlar" },
    { href: "/eviko/ombor/qoldiqlar", icon: ShoppingBag, label: "Ombor" },
];
...
export default function Sidebar({ mobileOpen = false, onMobileClose, onMobileOpen }: SidebarProps) {
    ...
    const useCRM = settings.useCRM ?? true;
    ...
    const mobileNavItems = useMemo(() => {
        return MOBILE_BOTTOM_NAV.filter(item => {
            if (item.href === "/eviko/reports" && !useAnalytics) return false;
            if (item.href.startsWith("/eviko/ombor") && !useWarehouse) return false;
            return true;
        });
