...
export const StaffService = {
    ...
    > {
        ...
        try { permissions = typeof matched.permissions === "string" ? JSON.parse(matched.permissions) : (matched.permissions as any); } catch { permissions = []; }
    ...
    parsePermissions(staff: StaffRecord): string[] {
        try { return typeof staff.permissions === "string" ? JSON.parse(staff.permissions) : (staff.permissions as any); } catch { return []; }
    },
};
