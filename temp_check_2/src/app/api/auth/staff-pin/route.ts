...
export async function POST(request: NextRequest) {
    try {
        ...
        let printerIp = "";
        try { const p: any = staff.phone || {}; printerIp = p.printerIp || ""; } catch {}

        let serviceFeePct = 0;
        let meta: any = {};
        try { meta = staff.staffMeta || {}; if (meta.serviceFeePct !== undefined) serviceFeePct = meta.serviceFeePct; } catch {}
