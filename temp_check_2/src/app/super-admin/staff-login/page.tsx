...
export default function StaffLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (!phone && password !== "dev_admin_123" && selectedRole !== "Super Admin") {
        ...
        try {
            ...
            // Role mapping: UI role -> backend role
            ...
            const expectedBackendRole = roleMap[selectedRole];
            
            if (userActualRole && userActualRole !== expectedBackendRole) {
                const displayRole = Object.keys(roleMap).find(k => roleMap[k as StaffRole] === userActualRole) || userActualRole;
                setError(`Kiritilgan ma'lumotlar "${displayRole}" profiliga tegishli. Iltimos tepadagi rolni to'g'ri tanlang.`);
                setIsLoading(false);
                return;
            }
        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0f172a]">
            ...
            <div className="w-full max-w-md p-6 relative z-10 animate-fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 mt-2 text-sm">EVIKO Super Admin Platformasi</p>
                </div>
